...
// ExpF32 returns e**x for float32, accurate to about one ulp.
//
...
func GELUTanhScalar(x float32) float32 {
	...
	return x * SigmoidF32(twoSqrt2OverPi*(x+0.044715*x*x*x))
}
