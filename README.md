...
multi-file and ZIP uploads, and public web URLs (with clean full-article
imports for Wikipedia), plus an interactive retrieval preview; see
[Knowledge base search](server/README.md#knowledge-base-search-rag).
